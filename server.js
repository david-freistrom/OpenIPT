...
console.log("Write PUBLIC_LOGIN_RESPONSE");
var iptCommand_A = new IptCommand(Constants.PUBLIC_LOGIN_RESPONSE);
iptCommand_A.getHeader().setSequenceNumber(0);
iptCommand_A.getHeader().setReserved(0);
iptCommand_A.getMessage().setResponse(0x00);
iptCommand_A.getMessage().setReactionTime(10);
iptCommand_A.getMessage().setNewAddress("192.168.1.1");
var buffer = iptCommand_A.write();	
console.log("Parse PUBLIC_LOGIN_RESPONSE");
var iptCommand_B = IptCommand.parse(buffer.buffer);
...
iptCommand_A.getHeader().setSequenceNumber(0);
iptCommand_A.getHeader().setReserved(0);
iptCommand_A.getMessage().setResponse(0);
var buffer = iptCommand_A.write();
...
console.log("Write MAINTENANCE_RESPONSE");
var iptCommand_X = new IptCommand(Constants.MAINTENANCE_RESPONSE);
iptCommand_X.getHeader().setSequenceNumber(0);
iptCommand_X.getHeader().setReserved(0);
iptCommand_X.getMessage().setResponse(0);
var buffer = iptCommand_X.write();
console.log("Parse MAINTENANCE_RESPONSE");
var iptCommand_C = IptCommand.parse(buffer.buffer);

console.log("");

console.log("Write MULTI_PUBLIC_LOGIN_REQUEST");
var iptCommand_X = new IptCommand(Constants.MULTI_PUBLIC_LOGIN_REQUEST);
iptCommand_X.getHeader().setSequenceNumber(0);
iptCommand_X.getHeader().setReserved(0x01);
iptCommand_X.getHeader().setConnectionId(0);
iptCommand_X.getMessage().setAccount("admin");
iptCommand_X.getMessage().setPassword("password");
iptCommand_X.getMessage().setCountRequested(1);
var buffer = iptCommand_X.write();
console.log("Parse MULTI_PUBLIC_LOGIN_REQUEST");
var iptCommand_C = IptCommand.parse(buffer.buffer);

console.log("");

console.log("Write MULTI_PUBLIC_LOGIN_RESPONSE");
var iptCommand_X = new IptCommand(Constants.MULTI_PUBLIC_LOGIN_RESPONSE);
iptCommand_X.getHeader().setSequenceNumber(0);
iptCommand_X.getHeader().setReserved(1);
iptCommand_X.getHeader().setConnectionId(0);
iptCommand_X.getMessage().setResponse(0);
iptCommand_X.getMessage().setReactionTime(1);
iptCommand_X.getMessage().setNewAddress("192.168.1.1");
iptCommand_X.getMessage().setCountConfirmed(1);
var buffer = iptCommand_X.write();
console.log("Parse MULTI_PUBLIC_LOGIN_RESPONSE");
var iptCommand_C = IptCommand.parse(buffer.buffer);

console.log("");

console.log("Write MULTI_SCRAMBLED_LOGIN_REQUEST");
var iptCommand_X = new IptCommand(Constants.MULTI_SCRAMBLED_LOGIN_REQUEST);
iptCommand_X.getHeader().setSequenceNumber(0);
iptCommand_X.getHeader().setReserved(1);
iptCommand_X.getHeader().setConnectionId(0);
iptCommand_X.getMessage().setAccount("admin");
iptCommand_X.getMessage().setPassword("password");
iptCommand_X.getMessage().setScrambleKey("0102030405060708090001020304050607080900010203040506070809000001");
iptCommand_X.getMessage().setCountRequested(1);
var buffer = iptCommand_X.write();1
console.log("Parse MULTI_SCRAMBLED_LOGIN_REQUEST");
var iptCommand_C = IptCommand.parse(buffer.buffer);

console.log("");

console.log("Write MULTI_SCRAMBLED_LOGIN_RESPONSE");
var iptCommand_X = new IptCommand(Constants.MULTI_SCRAMBLED_LOGIN_RESPONSE);
iptCommand_X.getHeader().setSequenceNumber(0);
iptCommand_X.getHeader().setReserved(1);
iptCommand_X.getHeader().setConnectionId(0);
iptCommand_X.getMessage().setResponse(0);
...
iptCommand_X.getMessage().setCountConfirmed(1);
var buffer = iptCommand_X.write();
console.log("Parse MULTI_SCRAMBLED_LOGIN_RESPONSE");
var iptCommand_C = IptCommand.parse(buffer.buffer);
